...
ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_chromatin_state_enrichment.png", combined_chrom, width = 10, height = 6, dpi = 300)

write.csv(chrom_res_annotated, 
          "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_chromatin_state_enrichment_results.csv",
          row.names = FALSE)
...
if (nrow(tissue_sig) > 0) {
  ...
  # Save plot
  ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_tissue_signature_enrichment_TiSigLoyfer.png", 
...
write.csv(tissue_annotated,
          "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_tissue_signature_enrichment_TiSigLoyfer_results.csv",
          row.names = FALSE)
...
if (nrow(tissue_sig) > 0) {
  ...
  # Save plot
  ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_tissue_signature_enrichment_TiSigBLUEPRINT.png", 
         combined_tissue, width = 10, height = 6, dpi = 300)
...
# Save tissue enrichment results
write.csv(tissue_annotated,
          "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_tissue_signature_enrichment_TiSigBLUEPRINT_results.csv",
          row.names = FALSE)
...
ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_cpg_island_context_enrichment.png", cpg_context_plot, width = 10, height = 6, dpi = 300)

write.csv(cgi_annotated, 
          "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_cgi_enrichment_results.csv",
          row.names = FALSE)
...
ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_enrichment_for_genomic_region.png", p_metagene, width = 10, height = 6, dpi = 300)

write.csv(metagene_df, 
          "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/DunedinPACE_metagene_enrichment_results.csv",
          row.names = FALSE)