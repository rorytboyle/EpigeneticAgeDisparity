...
gene_res <- read_csv('/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_gene_enrichment_results.csv')
...
# Save output ####
output_rds <- "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_pathway_enrichment_results_hg38.rds"
saveRDS(sig_pathways, output_rds)

# Save simplified version as CSV (for easy viewing)
output_csv <- "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_pathway_enrichment_results_hg38.csv"
