...
gene_res <- read_csv('/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/gene_enrichment_results_overlap2.csv')
...
# Save output ####
output_rds <- "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/pathway_enrichment_results_hg38.rds"
saveRDS(sig_pathways, output_rds)

# Save simplified version as CSV (for easy viewing)
output_csv <- "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/pathway_enrichment_results_hg38.csv"
...
ggsave(pathway_table, 
       filename = "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/top20_enriched_pathways_hg38.png", 
...
ggsave(p_highlighted, 
       filename = "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/enriched_pathways_highlight_fatty_acid_hg38.png", 
       width = 8, height = 6, dpi = 300)
