# This script runs a gene enrichment analysis, using KnowYourCG, for Horvath CpGs that are differently methylated by genetic ancestry.
...
query_cpgs <- readRDS("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/20250201_hypermethylated_Horvath_CpGs_African_Ancestry.rds")
...
write.csv(gene_res, '/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_gene_enrichment_results.csv', row.names = FALSE)
...
ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_gene_enrichment_analysis_overlap_all.png", 
       combined_genes, 
       width = 6, 
...
# Save
ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_gene_enrichment_analysis_overlap_greaterThan1.png", combined_genes_overlap_greaterThan1, width = 6, height = 4, dpi = 300)
...
print(p)
# Save
write.csv(final_results, "/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_gene_enrichment_overlap_greaterThan1_neurodegenerative_associations.csv", row.names = FALSE)
ggsave("/Users/rorytb/Library/CloudStorage/Box-Box/PennMedicineBiobank/DNAmethylation/results/Horvath_gene_enrichment_overlap_greaterThan1_neurodegenerative_associations_plot.png",
       p, 
       width = 10.3, 
       height = 5.47, 
       units = "in",
